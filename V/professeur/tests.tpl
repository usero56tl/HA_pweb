            ...
            <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="index.php?controle=professeur&action=tests" method="post">
                            <div class="button"> 
                              <input type="submit" type="button" name="<?php echo($tests[$i]['id_test'])?>" class="btn btn-danger" value="Modifier"/>
                            </div>
                        </form>
                    </div>
                </div>
